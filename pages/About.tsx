...
import { Package, Truck, ShieldCheck, Award, ArrowRight } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Link 
                to="/products" 
                className="inline-flex items-center px-8 py-3.5 bg-brand-green text-white rounded-full font-bold hover:bg-brand-green/90 transition-all shadow-lg group text-[9px] uppercase tracking-widest"
              >
                Explore the Harvest <ArrowRight className="ml-2 w-3.5 h-3.5 group-hover:translate-x-1 transition-transform text-brand-gold" />
              </Link>
            </div>
