          ...
          <div className="flex flex-col order-2">
            ...
            <div className="bg-brand-green p-6 lg:p-8 rounded-[32px] lg:rounded-[40px] border border-brand-gold/10 detail-animate shadow-xl">
              ...
              <button 
                ...
                className="w-full py-4 lg:py-5 bg-brand-gold text-white rounded-2xl lg:rounded-xl font-bold text-[10px] lg:text-[11px] uppercase tracking-[0.2em] hover:bg-white hover:text-brand-green transition-all shadow-lg flex items-center justify-center group"
              >
